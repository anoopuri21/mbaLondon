...
|-----------|-----------------|
| Building a new section | docs/03-DESIGN_SYSTEM.md + docs/05-CONTENT_SOURCE.md + existing CSS/HTML for similar section |
...
| Architecture question | docs/04-TECHNICAL_ARCHITECTURE.md |
...
5. Display font: Clash Display | Body font: Poppins
...
### Typography Defaults
Headlines: Clash Display, weight 600 (not 700)
